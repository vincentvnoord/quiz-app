...
namespace DataAccess.Mocks
{
    ...
    {
        private readonly Dictionary<int, Quiz> _quizzes = new Dictionary<int, Quiz>
        {
            { 1, new Quiz(1, "General Programming Knowledge", CreateProgrammingQuestions()) },
            { 2, new Quiz(2, "General Knowledge", GetGeneralKnowledgeQuestions()) }
        };
